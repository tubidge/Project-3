...
module.exports = app => {
    ...
    app.post('/add/goal', (req, res) => {
        ...
        goal.addGoal(userGoal).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/goal/:id', (req, res) => {
        goal.getGoal(req.params.id).then(data => {
            res.send(data);
    ...
    app.put('/goal/update/:id', (req, res) => {
        ...
        goal.updateGoal(req.params.id, colName, info).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.delete('/goal/:id', (req, res) => {
        goal.deleteGoal(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
