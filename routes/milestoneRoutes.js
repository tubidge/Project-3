...
module.exports = app => {
    ...
    app.post('/add/milestone', (req, res) => {
        ...
        milestone.addMilestone(userMilestone).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/all/milestones/:id', (req, res) => {
        milestone.getAllMilestones(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/milestone/:id', (req, res) => {
        milestone.getMilestone(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.put('/milestone/:id', (req, res) => {
        ...
        milestone.updateMilestone(req.params.id, colName, info).then(data => {
            res.send(data)
        }).catch(err => {
            res.catch(err)
        })
    ...
    app.delete('/milestone/:id', (req, res) => {
        milestone.deleteMilestone(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
