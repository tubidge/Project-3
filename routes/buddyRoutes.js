...
module.exports = app => {
    ...
    app.get('/buddy/owner/:id', (req, res) => {
        buddy.getByOwner(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/buddy/goal/:id', (req, res) => {
        buddy.getByGoal(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/buddy/buddy/:id', (req, res) => {
        buddy.getBuddyId(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.get('/buddy/:id', (req, res) => {
        buddy.getById(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.post('/buddy/add', (req, res) => {
        ...
        buddy.addBuddyRelation(newBuddy).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.put('/buddy/:id', (req, res) => {
        ...
        buddy.updateBuddyRelation(req.params.id, colName, info).then(data => {
            res.send(data)
        }).catch(err => {
            res.send(err)
        })
    ...
    app.delete('/buddy/:id', (req, res) => {
        buddy.deleteBuddyRelation(req.params.id).then(data => {
            res.send(data)
        }).catch(err => {
            console.log(err)
            res.send(err)
